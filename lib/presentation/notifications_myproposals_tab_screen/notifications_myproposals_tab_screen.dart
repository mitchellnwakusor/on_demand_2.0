import 'package:flutter/material.dart';import 'package:job_demo/core/app_export.dart';import 'package:job_demo/presentation/notifications_general_page/notifications_general_page.dart';import 'package:job_demo/presentation/notifications_my_proposals_page/notifications_my_proposals_page.dart';import 'package:job_demo/widgets/app_bar/appbar_image.dart';import 'package:job_demo/widgets/app_bar/appbar_image_1.dart';import 'package:job_demo/widgets/app_bar/appbar_title.dart';import 'package:job_demo/widgets/app_bar/custom_app_bar.dart';class NotificationsMyproposalsTabScreen extends StatefulWidget {const NotificationsMyproposalsTabScreen({Key? key}) : super(key: key);

@override NotificationsMyproposalsTabScreenState createState() =>  NotificationsMyproposalsTabScreenState();
 }

// ignore_for_file: must_be_immutable
class NotificationsMyproposalsTabScreenState extends State<NotificationsMyproposalsTabScreen> with  TickerProviderStateMixin {late TabController tabviewController;
